...
/*class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return new MaterialApp(
      ...
      home: new CreditDebitCard(title: Strings.appName),
    );
  }
}*/

class CreditDebitCard extends StatefulWidget {
  CreditDebitCard({Key key, this.title}) : super(key: key);
  final String title;

  @override
  _CreditDebitCardState createState() => new _CreditDebitCardState();
}
